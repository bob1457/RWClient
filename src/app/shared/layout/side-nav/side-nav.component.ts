...
export class SideNavComponent implements OnInit {
  ...
  ngOnInit() {
    debugger;
    this.store.pipe(select(getUserInfo)).subscribe((userData) => { this.user = JSON.parse(localStorage.getItem('auth')); localStorage.setItem('auth', JSON.stringify(userData)) } );
